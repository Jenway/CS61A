...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    ans = [dice() for i in range(num_rolls)]
    return 1 if 1 in ans else sum(ans)
...
def hog_pile(player_score, opponent_score):
    ...
    # begin problem 4
    "*** your code here ***"
    return opponent_score % 10 if player_score % 10 == opponent_score % 10 else 0
    # end problem 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 7
        ...
        print(message) if message != None else None
...
def announce_lead_changes(score0, score1, last_leader=None):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    leader = 0 if score0 > score1 else None if score0 == score1 else 1
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    num_rolls = [average_dice(i,dice) for i in range(1,11)]
    return num_rolls.index(max(num_rolls))+1
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score > opponent_score:
        rolls = 6-int((score-opponent_score)//scala)
        return hog_pile_strategy(score,opponent_score,10,1 if rolls <=1 else rolls)
    else:
